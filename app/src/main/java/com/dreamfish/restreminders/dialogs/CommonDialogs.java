...
import com.dreamfish.restreminders.AboutActivity;
import com.dreamfish.restreminders.HelpActivity;
import com.dreamfish.restreminders.R;
import com.dreamfish.restreminders.SettingsActivity;
import com.dreamfish.restreminders.utils.AlertDialogTool;
import com.dreamfish.restreminders.utils.ExceptionUtils;

import androidx.appcompat.app.AlertDialog;

public class CommonDialogs {

  public static final int RESULT_SETTING_ACTIVITY = 1;
  ...
  public static void showException(Activity activity, Exception e) {
    ...
    ((TextView)v.findViewById(R.id.text_title)).setText(R.string.title_exception);
